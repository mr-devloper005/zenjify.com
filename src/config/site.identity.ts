export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'zenjify',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Zenjify',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'zenjify.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://zenjify.com',
